public class TypeSort {
  ...
  public static void main(String[] args) {
    ...
    bubbleSort(arr, arr.length, "ASC"); // Panggil bubbleSort untuk pengurutan ascending
    System.out.println("\nArray setelah diurutkan secara ascending:");
    printArray(arr);

    bubbleSort(arr, arr.length, "DESC"); // Panggil bubbleSort untuk pengurutan descending
